...
### Added
* Added [Leaflet](https://leafletjs.com/) interactive mapping (PR [#157](https://github.com/plotly/dash-cytoscape/pull/157))
* Added the ability to toggle a context menu (PR [#157](https://github.com/plotly/dash-cytoscape/pull/157))

### Changed

### Fixed
* Build issues with Python `setup.py` (Issue [#156](https://github.com/plotly/dash-cytoscape/issues/156))
