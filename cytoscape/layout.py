...
layout = html.Div([
    html.Div(className='row', style={'overflow': 'visible'}, children=[
        ...
        html.Div(
            ...
            children=dcc.Tabs(id='tabs', value='UI', children=[
                dcc.Tab(
                    ...
                    children=html.Div(
                        ...
                        children=[
                            ...
                            drc.NamedCard(title='Compound parent size', size=4,
                                          children=[
                                              drc.NamedRadioItems(
                            ...
                            drc.NamedCard(title='Loop edges', size=4,
                                          children=[
                                              drc.NamedInput(
                            ...
                            drc.NamedCard(title='Edge Arrow', size=4,
                                          children=[
                                              html.Div(
                            ...
                            drc.NamedCard(title='Edge Endpoints', size=4,
                                          children=[
                                              drc.NamedRadioItems(
                            ...
                            drc.NamedCard(title='Font Styling', size=4,
                                          children=[
                                              drc.NamedDropdown(
                            ...
                            drc.NamedCard(title='Text Wrapping', size=4,
                                          children=[
                                              drc.NamedDropdown(
                            ...
                            drc.NamedCard(title='Label Alignment', size=4,
                                          children=[
                                              drc.NamedRadioItems(
