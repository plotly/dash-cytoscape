...
- tapNodeData (dict; optional): The data dictionary of a node returned when you tap or click it. Cannot be modified by a
Dash callback.
- tapEdge (dict; optional): The complete edge dictionary returned when you tap or click it. Cannot be modified by a
Dash callback.
    ...
    2. General items (for all elements):
        ...
        - `selected` (boolean)
        - `style` (dictionary)
- tapEdgeData (dict; optional): The data dictionary of an edge returned when you tap or click it. Cannot be modified by a
Dash callback.
- mouseoverNodeData (dict; optional): The data dictionary of a node returned when you hover over it. Cannot be modified by a
Dash callback.
- mouseoverEdgeData (dict; optional): The data dictionary of an edge returned when you hover over it. Cannot be modified by a
Dash callback.
